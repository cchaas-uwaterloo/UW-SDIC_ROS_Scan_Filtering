...
private:
  ...
  */
  ...
  PointCloud::Ptr filteredScanLidarInv_;                                        // inverted representation of filtered point cloud
  sensor_msgs::PointCloud2 scanOutput_;                                         // Filtered scan cloud converted to ROS message format
  sensor_msgs::PointCloud2 scanOutputInv_;                                      // Filtered inverted scan cloud converted to ROS message format
  ...
  bool acknowledgeSent;                                                         // Latch variable to only send acknowledge once each time a new set of image data is recieved
